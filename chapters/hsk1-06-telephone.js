...
registerChapter({
  ...
  TH(),
  C("你的手机号是多少？","Nǐ de shǒujīhào shì duōshao?","Quel est ton numéro de portable ?",0.55), P(3,"…"),
  ...
  TH(),
  C("手机","shǒujī","téléphone portable",0.6), P(1.5,"…"),
  N("Comment dit-on « zéro » ?"),
  TH(),
  C("零","líng","zéro",0.6), P(1.5,"…"),
  ...
  TH(),
  C("明天你去哪儿？","Míngtiān nǐ qù nǎr?","Où vas-tu demain ?",0.6), P(2.5,"…"),
  ...
  TH(),
  C("我想去超市买东西。","Wǒ xiǎng qù chāoshì mǎi dōngxi.","Je veux aller au supermarché acheter des choses.",0.55), P(3,"…"),
  ...
  TH(),
  C("我想去超市买东西。","Wǒ xiǎng qù chāoshì mǎi dōngxi.","Je veux aller au supermarché acheter des choses.",0.6), P(2,"…"),
  N("On vous demande :"),
  ...
  TH(),
  C("明天","míngtiān","demain",0.6), P(1.5,"…"),
  N("Demandez : où vas-tu demain ?"),
  TH(),
  C("明天你去哪儿？","Míngtiān nǐ qù nǎr?","Où vas-tu demain ?",0.6), P(1.5,"…"),
  ...
  TH(),
  C("我想去西安饭店，那边的包子非常好吃。","Wǒ xiǎng qù Xī'ān Fàndiàn, nàbian de bāozi fēicháng hǎochī.","Je veux aller au restaurant Xi'an, leurs bāozi sont délicieux là-bas.",0.5), P(3,"…"),
  ...
  TH(),
  C("我们去哪儿吃晚饭？","Wǒmen qù nǎr chī wǎnfàn?","Où allons-nous dîner ?",0.6), P(2,"…"),
  N("Répondez : « Je veux aller au restaurant Xi'an, leurs [[包子|bāozi]] sont délicieux là-bas. »"),
  TH(),
  C("我想去西安饭店，那边的包子非常好吃。","Wǒ xiǎng qù Xī'ān Fàndiàn, nàbian de bāozi fēicháng hǎochī.","Je veux aller au restaurant Xi'an, leurs bāozi sont délicieux là-bas.",0.55), P(2.5,"…"),
  ...
  TH(),
  C("你的手机号是多少？","Nǐ de shǒujīhào shì duōshao?","Quel est ton numéro de portable ?",0.6), P(1.5,"…"),
  N("Demandez : où vas-tu demain ?"),
  TH(),
  C("明天你去哪儿？","Míngtiān nǐ qù nǎr?","Où vas-tu demain ?",0.6), P(1.5,"…"),
  N("Dites : je veux aller au supermarché acheter des choses."),
  TH(),
  C("我想去超市买东西。","Wǒ xiǎng qù chāoshì mǎi dōngxi.","Je veux aller au supermarché acheter des choses.",0.55), P(2,"…"),
  N("Demandez : comment y allons-nous ?"),
  TH(),
  C("我们怎么去？","Wǒmen zěnme qù?","Comment y allons-nous ?",0.6), P(1.5,"…"),
  N("Et pour finir : on y va en taxi."),
  TH(),
  C("坐出租车去。","Zuò chūzūchē qù.","On y va en taxi.",0.6), P(1.5,"…"),
