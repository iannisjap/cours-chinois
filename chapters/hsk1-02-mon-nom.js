...
registerChapter({
  ...
  TH(),
  C("我","wǒ","je, moi",0.6), P(1.5,"…"),
  N("Demandez : comment t'appelles-tu ?"),
  TH(),
  C("你叫什么名字？","Nǐ jiào shénme míngzi?","Comment t'appelles-tu ?",0.6), P(1.5,"…"),
  ...
  TH(),
  C("我是老师。","Wǒ shì lǎoshī.","Je suis professeur.",0.6), P(2.5,"…"),
  ...
  TH(),
  C("我不是安妮，我是白家月。","Wǒ bú shì Ānnī, wǒ shì Bái Jiāyuè.","Je ne suis pas Annie, je suis Bai Jiayue.",0.55), P(3,"…"),
  ...
  TH(),
  C("我是学生。","Wǒ shì xuéshēng.","Je suis étudiant.",0.6), P(1.5,"…"),
  N("Dites : je ne suis pas professeur."),
  TH(),
  C("我不是老师。","Wǒ bú shì lǎoshī.","Je ne suis pas professeur.",0.6), P(1.5,"…"),
  N("Excusez-vous, puis imaginez la réponse « ce n'est rien »."),
  TH(),
  C("对不起！","Duìbuqǐ!","Pardon !",0.6), P(1.5,"…"),
  C("没关系！","Méi guānxi!","Ce n'est rien !",0.6), P(1.5,"…"),
  ...
  TH(),
  C("很高兴认识你。","Hěn gāoxìng rènshi nǐ.","Très heureux de te connaître.",0.6), P(2.5,"…"),
  ...
  TH(),
  C("很高兴认识你。","Hěn gāoxìng rènshi nǐ.","Très heureux de te connaître.",0.6), P(2,"…"),
  ...
  TH(),
  C("请问，你叫什么名字？","Qǐngwèn, nǐ jiào shénme míngzi?","Excusez-moi, comment t'appelles-tu ?",0.6), P(1.5,"…"),
  N("Dites : je m'appelle Li Wen."),
  TH(),
  C("我叫李文。","Wǒ jiào Lǐ Wén.","Je m'appelle Li Wen.",0.6), P(1.5,"…"),
  ...
  TH(),
  C("很高兴认识你。","Hěn gāoxìng rènshi nǐ.","Très heureux de te connaître.",0.6), P(1.5,"…"),
