...
registerChapter({
  ...
  N("Répondez : « Il est sous la table. »"),
  TH(),
  C("它在桌子下呢。","Tā zài zhuōzi xià ne.","Il est sous la table.",0.6),
  ...
  TH(),
  C("桌子下","zhuōzi xià","sous la table",0.6),
  ...
  N("Demandez : « Peux-tu arriver à 14 h ? »"),
  TH(),
  C("下午两点你能到吗？","Xiàwǔ liǎng diǎn nǐ néng dào ma?","Peux-tu arriver à 14 h ?",0.6),
  ...
  TH(),
  C("在学校","zài xuéxiào","à l'école",0.6),
  N("Demandez : peux-tu arriver ?"),
  TH(),
  C("你能到吗？","Nǐ néng dào ma?","Peux-tu arriver ?",0.6),
  ...
  TH(),
  C("没吃呢。","Méi chī ne.","Pas encore.",0.6),
  N("Dites : « Dans les grands hôpitaux il y a beaucoup de patients, les médecins sont très occupés. »"),
  TH(),
  C("大医院病人多，医生非常忙。","Dà yīyuàn bìngrén duō, yīshēng fēicháng máng.","Dans les grands hôpitaux il y a beaucoup de patients, les médecins sont très occupés.",0.55),
  ...
  TH(),
  C("我在学校吃午饭。","Wǒ zài xuéxiào chī wǔfàn.","Je déjeune à l'école.",0.6),
