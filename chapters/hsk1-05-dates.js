...
registerChapter({
  ...
  TH(),
  C("今天几号？","Jīntiān jǐ hào?","Quelle est la date aujourd'hui ?",0.6), P(2.5,"…"),
  ...
  TH(),
  C("今天几号？","Jīntiān jǐ hào?","Quelle est la date aujourd'hui ?",0.6), P(1.5,"…"),
  N("Demandez : quel jour de la semaine ?"),
  TH(),
  C("星期几？","Xīngqī jǐ?","Quel jour de la semaine ?",0.6), P(1.5,"…"),
  ...
  TH(),
  C("你会做饭吗？","Nǐ huì zuò fàn ma?","Sais-tu cuisiner ?",0.6), P(2.5,"…"),
  ...
  TH(),
  C("你会做饭吗？","Nǐ huì zuò fàn ma?","Sais-tu cuisiner ?",0.6), P(1.5,"…"),
  N("Dites : je sais faire des jiaozi."),
  TH(),
  C("我会做饺子。","Wǒ huì zuò jiǎozi.","Je sais faire des jiaozi.",0.6), P(1.5,"…"),
  ...
  TH(),
  C("下班吗？","Xiàbān ma?","As-tu fini le travail ?",0.6), P(2,"…"),
  ...
  TH(),
  C("这是你的新电脑吗？","Zhè shì nǐ de xīn diànnǎo ma?","C'est ton nouvel ordinateur ?",0.6), P(2.5,"…"),
  ...
  N("Répondez : « Oui, c'est mon nouvel ordinateur. »"),
  TH(),
  C("是的，是我的新电脑。","Shì de, shì wǒ de xīn diànnǎo.","Oui, c'est mon nouvel ordinateur.",0.6), P(2,"…"),
  ...
  TH(),
  C("今天我休息。","Jīntiān wǒ xiūxi.","Aujourd'hui, je suis en repos.",0.6), P(1.5,"…"),
  N("Demandez : sais-tu cuisiner ?"),
  TH(),
  C("你会做饭吗？","Nǐ huì zuò fàn ma?","Sais-tu cuisiner ?",0.6), P(1.5,"…"),
  N("Dites : je sais faire des nouilles."),
  TH(),
  C("我会做面条儿。","Wǒ huì zuò miàntiáor.","Je sais faire des nouilles.",0.6), P(1.5,"…"),
  N("Et pour finir : je l'aime beaucoup."),
  TH(),
  C("我很喜欢它。","Wǒ hěn xǐhuan tā.","Je l'aime beaucoup.",0.6), P(1.5,"…"),
