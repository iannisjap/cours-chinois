...
registerChapter({
  ...
  TH(),
  C("现在几点？","Xiànzài jǐ diǎn?","Quelle heure est-il ?",0.6), P(2.5,"…"),
  ...
  TH(),
  C("早上八点四十。","Zǎoshang bā diǎn sìshí.","Il est 8 h 40 du matin.",0.6), P(2.5,"…"),
  ...
  TH(),
  C("好的，我们下午两点见吧。","Hǎo de, wǒmen xiàwǔ liǎng diǎn jiàn ba.","D'accord, retrouvons-nous à 14 h.",0.55), P(3,"…"),
  ...
  N("Répondez : « Il est 8 h 40 du matin. »"),
  TH(),
  C("早上八点四十。","Zǎoshang bā diǎn sìshí.","Il est 8 h 40 du matin.",0.6), P(2,"…"),
  N("Ajoutez : « J'ai cours à 10 h 10 ce matin. »"),
  TH(),
  C("我上午十点十分有课。","Wǒ shàngwǔ shí diǎn shí fēn yǒu kè.","J'ai cours à 10 h 10 ce matin.",0.6), P(2,"…"),
  ...
  TH(),
  C("现在几点？","Xiànzài jǐ diǎn?","Quelle heure est-il ?",0.6), P(1.5,"…"),
  N("Dites : la matinée."),
  TH(),
  C("上午","shàngwǔ","la matinée",0.6), P(1.5,"…"),
  ...
  TH(),
  C("下午我想去电影院看电影，你去吗？","Xiàwǔ wǒ xiǎng qù diànyǐngyuàn kàn diànyǐng, nǐ qù ma?","Cet après-midi je veux aller au cinéma voir un film, tu viens ?",0.5), P(3,"…"),
  ...
  TH(),
  C("我不想去，下午还有事。","Wǒ bù xiǎng qù, xiàwǔ hái yǒu shì.","Je ne veux pas venir, j'ai encore des choses à faire cet après-midi.",0.55), P(3,"…"),
  ...
  TH(),
  C("下午我想去电影院看电影，你去吗？","Xiàwǔ wǒ xiǎng qù diànyǐngyuàn kàn diànyǐng, nǐ qù ma?","Cet après-midi je veux aller au cinéma voir un film, tu viens ?",0.55), P(2.5,"…"),
  ...
  TH(),
  C("好的。明天呢？","Hǎo de. Míngtiān ne?","D'accord. Et demain ?",0.6), P(2,"…"),
  ...
  TH(),
  C("上课","shàngkè","aller en cours",0.6), P(1.5,"…"),
  N("Dites : finir les cours."),
  TH(),
  C("下课","xiàkè","finir les cours",0.6), P(1.5,"…"),
  ...
  TH(),
  C("喂，你在哪儿呢？","Wèi, nǐ zài nǎr ne?","Allô, où es-tu ?",0.6), P(2.5,"…"),
  ...
  TH(),
  C("我晚上六点半下班。","Wǒ wǎnshang liù diǎn bàn xiàbān.","Je finis le travail à 18 h 30 ce soir.",0.55), P(3,"…"),
  ...
  TH(),
  C("我八点去医院上班。","Wǒ bā diǎn qù yīyuàn shàngbān.","Je vais travailler à l'hôpital à 8 h.",0.6), P(2.5,"…"),
  ...
  N("Répondez : « Je suis à la maison. »"),
  TH(),
  C("我在家里呢。","Wǒ zài jiā li ne.","Je suis à la maison.",0.6), P(2,"…"),
  N("Dites : « Je finis le travail à 18 h 30 ce soir. »"),
  TH(),
  C("我晚上六点半下班。","Wǒ wǎnshang liù diǎn bàn xiàbān.","Je finis le travail à 18 h 30 ce soir.",0.6), P(2,"…"),
  N("On vous répond : « Je vais travailler à l'hôpital à 8 h. »"),
  C("我八点去医院上班。","Wǒ bā diǎn qù yīyuàn shàngbān.","Je vais travailler à l'hôpital à 8 h.",0.6), P(2,"…"),
  ...
  TH(),
  C("我们下午两点见吧。","Wǒmen xiàwǔ liǎng diǎn jiàn ba.","Retrouvons-nous à 14 h.",0.6), P(1.5,"…"),
  N("Dites : je vais au cinéma voir un film."),
  TH(),
  C("我去电影院看电影。","Wǒ qù diànyǐngyuàn kàn diànyǐng.","Je vais au cinéma voir un film.",0.6), P(1.5,"…"),
  N("Demandez au téléphone : où es-tu ?"),
  TH(),
  C("你在哪儿呢？","Nǐ zài nǎr ne?","Où es-tu ?",0.6), P(1.5,"…"),
  N("Et pour finir : je finis le travail à 18 h 30 ce soir."),
  TH(),
  C("我晚上六点半下班。","Wǒ wǎnshang liù diǎn bàn xiàbān.","Je finis le travail à 18 h 30 ce soir.",0.6), P(1.5,"…"),
