...
registerChapter({
  ...
  TH(),
  C("我是中国人。","Wǒ shì Zhōngguó rén.","Je suis chinois.",0.6), P(2.5,"…"),
  ...
  TH(),
  C("我是法国人。","Wǒ shì Fǎguó rén.","Je suis français.",0.6), P(2.5,"…"),
  ...
  TH(),
  C("我是中国人。","Wǒ shì Zhōngguó rén.","Je suis chinois.",0.6), P(1.5,"…"),
  N("Dites : mon professeur de chinois."),
  TH(),
  C("我的中文老师","wǒ de Zhōngwén lǎoshī","mon professeur de chinois",0.6), P(1.5,"…"),
  ...
  TH(),
  C("这是我女朋友。","Zhè shì wǒ nǚpéngyou.","C'est ma petite amie.",0.6), P(2.5,"…"),
  ...
  TH(),
  C("你女朋友是哪国人？","Nǐ nǚpéngyou shì nǎ guó rén?","Ta petite amie est de quel pays ?",0.55), P(3,"…"),
  ...
  TH(),
  C("这是谁？","Zhè shì shéi?","Qui est-ce ?",0.6), P(1.5,"…"),
  N("Demandez : tu es de quel pays ?"),
  TH(),
  C("你是哪国人？","Nǐ shì nǎ guó rén?","Tu es de quel pays ?",0.6), P(1.5,"…"),
  ...
  TH(),
  C("对，还很忙。","Duì, hái hěn máng.","Oui, encore très occupé.",0.6), P(2.5,"…"),
  ...
  TH(),
  C("你工作还忙吗？","Nǐ gōngzuò hái máng ma?","Es-tu encore occupé par le travail ?",0.6), P(1.5,"…"),
  N("Dites : tu me manques beaucoup."),
  TH(),
  C("我很想你。","Wǒ hěn xiǎng nǐ.","Tu me manques beaucoup.",0.6), P(1.5,"…"),
